...
local rofiTheme   	= "~/.config/rofi/launchers/type-1/launcher.sh"
local reloadWaybar 	= "~/.config/waybar/scripts/launch.sh"
...
hl.config({
    general = {
        ...
        col = {
            active_border = { colors = {"rgba(595959aa)"} }, --8b0000aa
...
hl.bind(mainMod .. " + D", hl.dsp.exec_cmd(rofiTheme))
